 ...
 */
stock C_PrintToChat(int client, const char[] szMessage, any:...)
{
 ...
 */
stock C_ReplyToCommand(int client, const char[] szMessage, any:...)
{
	char szCMessage[MAX_MESSAGE_LENGTH];
	SetGlobalTransTarget(client);
 ...
 * On error/Errors:   If the client is not connected or invalid.
 */
stock C_ReplyToCommandEx(int client, author, const char[] szMessage, any:...)
{
	char szCMessage[MAX_MESSAGE_LENGTH];
	SetGlobalTransTarget(client);
 ...
 * @return			  No return
 */
stock C_PrintToChatAll(const char[] szMessage, any:...)
{
	char szBuffer[MAX_MESSAGE_LENGTH];
 ...
 */
stock C_PrintToChatEx(int client, int author, const char[] szMessage, any:...)
{
	if (client <= 0 || client > MaxClients)
	{
		ThrowError("Invalid client index %d", client);
 ...
 */
stock C_PrintToChatAllEx(int author, const char[] szMessage, any:...)
{
	if (author < 0 || author > MaxClients)
	{
		ThrowError("Invalid client index %d", author);
 ...
 * @return			  No return
 */
stock C_RemoveTags(char[] szMessage, int maxlength)
{
 ...
 * @return		   No return
 */
stock C_SkipNextClient(int client)
{
	if (client <= 0 || client > MaxClients)
	{
		ThrowError("Invalid client index %d", client);
 ...
 */
stock C_Format(char[] szMessage, int maxlength, int author=NO_INDEX)
{
 ...
 */
stock C_FindRandomPlayerByTeam(int color_team)
{
 ...
 * @return			  No return.
 */
stock C_SayText2(int client, int author, const char[] szMessage)
{
 ...
 * @error
 */
stock C_ShowActivity(int client, const char[] format, any:...)
{
 ...
 * @error
 */
stock C_ShowActivityEx(int client, const char[] tag, const char[] format, any:...)
{
	if (sm_show_activity == null)
	{
		sm_show_activity = FindConVar("sm_show_activity");
 ...
 * @error
 */
stock C_ShowActivity2(int client, const char[] tag, const char[] format, any:...)
{
	if (sm_show_activity == null)
	{
		sm_show_activity = FindConVar("sm_show_activity");
